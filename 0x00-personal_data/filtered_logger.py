...
class RedactingFormatter(logging.Formatter):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        return filter_datum(
                self.fields, self.REDACTION, message, self.SEPERATOR
        )
...
def get_logger() -> logging.Logger:
    """
    Creates a logger to handle user data with sensitive
...
def get_db() -> connection.MySQLConnection:
    """
    Connect to the secure Holberton database using environment
    variables for for credentials.
    """
